...
## @backstage/plugin-adr@0.6.10-next.0
...
## @backstage/plugin-airbrake@0.3.27-next.0
...
## @backstage/plugin-allure@0.1.43-next.0
...
## @backstage/plugin-api-docs@0.10.1-next.0
...
## @backstage/plugin-azure-devops@0.3.9-next.0
...
## @backstage/plugin-azure-sites@0.1.16-next.0
...
## @backstage/plugin-badges@0.2.51-next.0
...
## @backstage/plugin-bazaar@0.2.19-next.0
...
## @backstage/plugin-bitrise@0.1.54-next.0
...
## @backstage/plugin-catalog-graph@0.3.1-next.0
...
## @backstage/plugin-catalog-import@0.10.3-next.0
...
## @backstage/plugin-cicd-statistics-module-gitlab@0.1.23-next.0
...
## @backstage/plugin-circleci@0.3.27-next.0
...
## @backstage/plugin-cloudbuild@0.3.27-next.0
...
## @backstage/plugin-code-climate@0.1.27-next.0
...
## @backstage/plugin-code-coverage@0.2.20-next.0
...
## @backstage/plugin-cost-insights@0.12.16-next.0
...
## @backstage/plugin-dynatrace@8.0.1-next.0
...
## @backstage/plugin-entity-feedback@0.2.10-next.0
...
## @backstage/plugin-entity-validation@0.1.12-next.0
...
## @backstage/plugin-explore@0.4.13-next.0
...
## @backstage/plugin-firehydrant@0.2.11-next.0
...
## @backstage/plugin-fossa@0.2.59-next.0
...
## @backstage/plugin-github-actions@0.6.8-next.0
...
## @backstage/plugin-github-deployments@0.1.58-next.0
...
## @backstage/plugin-github-issues@0.2.16-next.0
...
## @backstage/plugin-github-pull-requests-board@0.1.21-next.0
...
## @backstage/plugin-gocd@0.1.33-next.0
...
## @backstage/plugin-home@0.5.11-next.0
...
## @backstage/plugin-ilert@0.2.16-next.0
...
## @backstage/plugin-jenkins@0.9.2-next.0
...
## @backstage/plugin-kafka@0.3.27-next.0
...
## @backstage/plugin-kubernetes@0.11.2-next.0
...
## @backstage/plugin-kubernetes-cluster@0.0.3-next.0
...
## @backstage/plugin-lighthouse@0.4.12-next.0
...
## @backstage/plugin-linguist@0.1.12-next.0
...
## @backstage/plugin-newrelic-dashboard@0.3.2-next.0
...
## @backstage/plugin-nomad@0.1.8-next.0
...
## @backstage/plugin-octopus-deploy@0.2.9-next.0
...
## @backstage/plugin-org@0.6.17-next.0
...
## @backstage/plugin-org-react@0.1.16-next.0
...
## @backstage/plugin-pagerduty@0.6.8-next.0
...
## @backstage/plugin-periskop@0.1.25-next.0
...
## @backstage/plugin-playlist@0.2.1-next.0
...
## @backstage/plugin-puppetdb@0.1.10-next.0
...
## @backstage/plugin-rollbar@0.4.27-next.0
...
## @backstage/plugin-scaffolder@1.16.1-next.0
...
## @backstage/plugin-search@1.4.3-next.0
...
## @backstage/plugin-sentry@0.5.12-next.0
...
## @backstage/plugin-sonarqube@0.7.9-next.0
...
## @backstage/plugin-splunk-on-call@0.4.16-next.0
...
## @backstage/plugin-tech-insights@0.3.19-next.0
...
## @backstage/plugin-techdocs-addons-test-utils@1.0.24-next.0
...
## @backstage/plugin-todo@0.2.31-next.0
...
## @backstage/plugin-user-settings@0.7.13-next.0
...
## @backstage/plugin-vault@0.1.22-next.0
